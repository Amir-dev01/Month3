...
async def edit_product(call: types.CallbackQuery, state: FSMContext):
    ...
    collection = InlineKeyboardButton(text="Коллекция", callback_data="field_collection")
    keyboard.add(name_button, category_button, price_button, size_button, photo_button,collection)
